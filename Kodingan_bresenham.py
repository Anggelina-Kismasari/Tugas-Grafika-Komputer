...
# NIM         : 20051397034
# Kelas       : MI20B
# Studi Kasus : Gambar garis berikut menggunakan Algoritma Bresenham dengan titik awal A (10, 10) dan titik akhir B (21, 20)!
...
def GarisDenganBresenham(x1, y1, x2, y2):
    ...
    p = 2 * dx - dy #ini gatau diganti apa ngga
