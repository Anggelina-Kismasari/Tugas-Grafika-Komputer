...
# NIM         : 20051397034
# Kelas       : MI20B
# Studi Kasus : Gambar garis berikut menggunakan Algoritma Bresenham dengan titik awal A (10, 10) dan titik akhir B (25, 25)!
...
def GarisDenganBresenham(x1, y1, x2, y2):
    #Menentukan delta X dan Y serta gradien untuk mencari nilai pengubahan posisi
    x, y = x1, y1
...
def TampilanGaris():
    ...
    GarisDenganBresenham(10, 10, 25, 25)
    #Mengakhiri garis
    glEnd()
